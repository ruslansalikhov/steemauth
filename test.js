...
var tx = {
	...
	operations: [['vote', {
		...
		permlink: 'e169-beyond-bitcoin-dollarvigilante-talks-steem-blockpay-ico-grc-hangouts-billboard-campaign',
		weight: 10000
	}]],
	signatures: []
};
...
steem.api.login(username, password, function() {
	steem.api.getDynamicGlobalProperties(function(err, result) {
		...
		steem.api.broadcastTransactionWithCallback(function(){}, signedTransaction, function(err, result) {
